...
const Sidebar = ({ displayed, toggleMenu }) => {
    ...
    const infoParagraphs = [
        "Aviso: Se você não estiver aberto a ver o mundo sob diferentes perspectivas, a adquirir novos conhecimentos e a exercitar a tolerância às ideias alheias, pode ser que este site não seja para você.",
        ...
        "Antes de tudo, gostaria de agradecer sua visita e pelo seu interesse no conteúdo apresentado aqui.",
        "Gostaria de salientar que sou responsável pelo desenvolvimento integral do site, incluindo a parte de design, funcionalidades, páginas e banco de dados.",
